...
export default function ChartlistActions({toggleDisplay, chartinfo}) {
    ...
    const saveChartlist = (url) => {
        ...
        chartlists.push({...chartinfo, audioUrl: url});
    ...
    return (
        <div className='chart-list-action'>
            ...
            <button className='settingbtn' onClick={toggleHiddenStatus}>
